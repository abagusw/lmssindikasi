...
<html lang="en" dir="ltr" data-startbar="light" data-bs-theme="light">
    ...
    <head>
        ...
        <!-- App css -->
        <link href="<?= ASSETS_URL ?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= ASSETS_URL ?>assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= ASSETS_URL ?>assets/css/app.min.css" rel="stylesheet" type="text/css" />
    </head>
                                ...
                                <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        <a href="index.html" class="logo logo-admin">
                                            <img src="<?= ASSETS_URL ?>assets/images/logo-sm.png" height="50" alt="logo" class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 fw-semibold text-white fs-18">Aplikasi Membership Sindikasi</h4>   
                                        <p class="text-muted fw-medium mb-0">Sign in to continue</p>  
                                    </div>
                                </div>
                                <div class="card-body pt-0">                    
                                    <?= $session->get('msg') ?>                    
                                    <form class="my-4" action="<?= base_url() ?>auth/login" method="POST">            
